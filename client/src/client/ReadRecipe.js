        ...
        <div class="read-recipe-content">
          ...
          <article>
            <div className="recipe-about ">
              <p>
                <span className="recipe-about-span">{name},</span>{" "}
                {about_the_recipe}.
              </p>
            </div>
            ...
            <p className="recipe-steps">
              <span className="steps-span">First </span>
              {instructions}.
            </p>
            <br />
            <p>
            ...
            {!email && (
              <div>
                <p className="see-comments-error">
                  Please Finish Account SetUp See Comments
                </p>
              </div>
            )}
          ...
          <aside>
            ...
            {!email && (
              <div>
                <p className="write-comments-error">
                  Please Finish Account SetUp to comment
                </p>
              </div>
            )}

...
function HelpCenter() {
  ...
  const createMessage = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/contact/help", formData);

      toast.success("Your issue has been sent to the admin. We will get back to you as soon as possible. Thank you for your patience.");
